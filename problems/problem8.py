...
# My Pseudocode:
# grab n digits from the numbers
# multiply them and store the number if it's more than the last grabbed digits
...
answer = 0
arraysize = 13
for i in range(0, numbers.size - arraysize):
    # take the product of the numbers in the array
    y = numbers[i:i + arraysize].prod()
    if y > answer:
        answer = y
print(answer)
